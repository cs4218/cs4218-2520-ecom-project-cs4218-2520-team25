...
test.describe("Admin Product Management - End-to-End CRUD Product Flow", () => {
  ...
  test("admin can create, update then delete a new product", async ({ page }) => {
    ...
    // create product
    // ==========================================================================
    const PRODUCT_NAME = `[E2E Create Product] Test Product ${Date.now()}`;
    const PRODUCT_DESC = `Description for ${PRODUCT_NAME}`;
    const PRODUCT_PRICE = "123";
    const PRODUCT_QUANTITY = "456";
    ...
    // update product
    // ==========================================================================
    const UPDATED_DESC = `Updated description for ${PRODUCT_NAME}`;

    // navigate to update product name
    ...
    await expect(updatedCard.getByText(UPDATED_DESC)).toBeVisible();

...
const TEST_PRODUCT_ID = '66db427fdb0119d9234b27f9'; // real product ID from database
...
export default () => {
  const res = http.get(`http://localhost:6060/api/v1/product/product-photo/${TEST_PRODUCT_ID}`);
